          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: NetworkImage('https://subtlepatterns.com/patterns/noise_lines.png'),
                fit: BoxFit.cover,
              ),
            ),
          ),
                ...
                children: [
                  if (!controller.isOpen)
                    GestureDetector(
                      ...
                      child: Icon(Icons.heart_broken_rounded, size: 100,),
                    ),
        ...
        AnimatedBuilder(
          ...
          builder: (_, __) => Transform.scale(
            ...
            child: Opacity(
              ...
              child: const Icon(Icons.favorite, size: 200, color: Colors.pinkAccent),
            ),
          ),
        ),
        AnimatedBuilder(
