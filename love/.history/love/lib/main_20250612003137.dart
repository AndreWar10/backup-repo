        ...
        children: [
          ...
          Center(
            child: AnimatedContainer(
              ...
              width: controller.isOpen ? 1000 : 1000,
      ...
      children: [
        AnimatedBuilder(
          ...
          builder: (_, __) => Transform.scale(
            scale: 1 + _bigHeartController.value * 1.2, // aumentei o scale
            child: Opacity(
              opacity: 1 - _bigHeartController.value,
              child: const Icon(
                Icons.favorite,
                size: 400, // aumentei o tamanho
        ...
        AnimatedBuilder(
          ...
          builder: (_, __) => Transform.scale(
            scale: 1 + _smallHeartController.value * 0.4, // aumentei o scale
            child: Opacity(
