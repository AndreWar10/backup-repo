        ...
        children: [
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: NetworkImage(
                  'https://png.pngtree.com/background/20250108/original/pngtree-valentine-s-day-hearts-a-seamless-pattern-of-love-picture-image_15231792.jpg',
                ),
                fit: BoxFit.cover,
              ),
            ),
          ...
          Center(
            child: AnimatedContainer(
              ...
              width: controller.isOpen ? 1000 : 320,
              height: controller.isOpen ? 1000 : 320,
              ...
              child: Stack(
                ...
                children: [
                  ...
                  if (controller.isOpen) const ExplodingHearts(),
                  if (controller.isOpen)
                    Positioned(
                      top: 0,
                      right: 0,
...
class _ExplodingHeartsState extends State<ExplodingHearts>
      ...
      children: [
        AnimatedBuilder(
          ...
          builder: (_, __) => Transform.scale(
            scale: 1 + _bigHeartController.value * 0.6,
            child: Opacity(
        ...
        AnimatedBuilder(
          ...
          builder: (_, __) => Transform.scale(
            scale: 1 + _smallHeartController.value * 0.2,
            child: Opacity(
              opacity: 1 - _smallHeartController.value,
              child: const Icon(Icons.favorite, size: 150, color: Colors.pink),
            ),
          ),
        ),
      ],
